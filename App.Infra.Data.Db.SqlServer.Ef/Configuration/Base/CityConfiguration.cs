...
{
    public class CityConfiguration : IEntityTypeConfiguration<App.Domain.Core.HomeService.Base.Entities.City>
    {
        public void Configure(EntityTypeBuilder<City> builder)
        {
            ...
            builder.HasData(new List<City>()
            {
                ...
                new City() { Id = 26,Title = "دزفول" },
                new City() { Id = 27,Title = "آبادان" },
            });
        }
    }
}
