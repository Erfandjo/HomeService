...
namespace App.Domain.Core.HomeService.UserEntity.AppService
{
    public interface IUserAppService
    {
        ...
        public Task<Result> Login(string username, string password, bool rememberMe);
        ...
        public Task<IdentityResult> ChangePassword(UserChangePasswordDto user , CancellationToken cancellation);
